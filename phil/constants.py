...
NUM_TRAIN = 5985  # Train: 80% of images
NUM_VAL = 748     # Val:   10% of images
NUM_TEST = 748    # Test:  10% of images

NUM_PER_SPLIT = {"train1": 2992, "train2": 2993, "val": 748, "test": 748}
SPLIT_NAMES = ['train1', 'train2', 'val', 'test']
