...
def traverse_predicted(yolo_path: str, model_exp_dir: str, baseline_exp_dir : str, data_path: str, split_name: str, show_plot: bool, save_plot_dir: str):
    """
...
if __name__ == "__main__":
    ...
    traverse_predicted(args.yolo, args.model_exp_dir, args.baseline_exp_dir, args.data, args.split_name, args.show_plot, args.save_plot_dir)
